...
class AccountTabProfileBlock extends Block
{
    ...
    public function render($attributes, $content = '', $block = null)
    {
        ...
        $wrapperAttrs = get_block_wrapper_attributes([
            'class' => 'jankx-tab-panel jankx-tab-profile',
        ]);
    ...
    protected function enqueueAssets(): void
    {
        wp_enqueue_style(
            'jankx-my-account',
            get_template_directory_uri() . '/extensions/my-account/assets/frontend.css',
            [],
            '1.0.0'
        );
        ...
        wp_enqueue_script(
            'jankx-my-account',
            get_template_directory_uri() . '/extensions/my-account/assets/frontend.js',
            ['jquery'],
            '1.0.0',
            true
        );
